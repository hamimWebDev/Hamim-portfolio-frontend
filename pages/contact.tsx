              ...
              <div className="space-y-10">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-8">
                    ...
                    However, if you have any other requests or questions, don't hesitate to use the form or contact me directly.
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a href="tel:+15555555555" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                        +1 (555) 555-5555
                      </a>
                    </div>
                  </div>
