              ...
              <div className="relative border-l-4 border-primary-500 ml-6 pl-12 pb-6">
                ...
                <AnimatedSection className="mb-12" delay={0.1}>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Led a team of developers in building a large-scale web
                    application using Next.js and TypeScript. Implemented state
                    management with Redux, and integrated with various
                    third-party APIs. Reduced load times by 60% through code
                    optimization and improved architecture.
                  </p>
                </AnimatedSection>
                ...
                <AnimatedSection className="mb-12" delay={0.2}>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Developed and maintained multiple client projects using the
                    MERN stack. Created custom API solutions, implemented
                    authentication systems, and designed database schemas.
                ...
                <AnimatedSection className="mb-12" delay={0.3}>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Built responsive and interactive web interfaces using
                    React.js. Implemented design systems and component libraries
                    for consistent UI. Worked closely with designers to
                    translate visual designs into functional code.
                  </p>
                </AnimatedSection>
                ...
                <AnimatedSection delay={0.4}>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    ...
                    hands-on experience with various technologies. Learned about
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              <AnimatedSection direction="left">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md h-full">
                  <h3 className="text-2xl font-bold mb-6 border-b border-gray-200 dark:border-gray-700 pb-4">
                    Education
                  </h3>
